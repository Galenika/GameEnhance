...
void Offsets::GrabOffsets( )
{
	...
	offsets.ViewModelIndex = U::NetVars->GetOffset(charenc("DT_BaseCombatWeapon"), charenc("m_iViewModelIndex"));
	offsets.WorldModelIndex = U::NetVars->GetOffset(charenc("DT_BaseCombatWeapon"), charenc("m_iWorldModelIndex"));

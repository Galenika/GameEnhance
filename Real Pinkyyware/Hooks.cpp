...
{
	static auto pSetClanTag = reinterpret_cast<void(__fastcall*)(const char*, const char*)>(((DWORD)Utilities::Memory::FindPattern("engine.dll", (PBYTE)"53 56 57 8B DA 8B F9 FF 15", "xxxxxxxxx????xxxxxx")));
...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "XenoHook.xyz"); break;
		case 1:SetClanTag("         X", "XenoHook.xyz"); break;
		case 2:SetClanTag("        Xe", "XenoHook.xyz"); break;
		case 3:SetClanTag("       Xen", "XenoHook.xyz"); break;
		case 4:SetClanTag("      Xeno", "XenoHook.xyz"); break;
		case 5:SetClanTag("     XenoH", "XenoHook.xyz"); break;
		case 6:SetClanTag("    XenoHo", "XenoHook.xyz"); break;
		case 7:SetClanTag("   XenoHoo", "XenoHook.xyz"); break;
		case 8:SetClanTag("  XenoHook", "XenoHook.xyz"); break;
		case 9:SetClanTag(" XenoHook", "XenoHook.xyz"); break;
		case 10:SetClanTag("XenoHook ", "XenoHook.xyz"); break;
		case 11:SetClanTag("enoHook  ", "XenoHook.xyz"); break;
		case 12:SetClanTag("noHook   ", "XenoHook.xyz"); break;
		case 13:SetClanTag("oHook    ", "XenoHook.xyz"); break;
		case 14:SetClanTag("Hook     ", "XenoHook.xyz"); break;
		case 15:SetClanTag("ook      ", "XenoHook.xyz"); break;
		case 16:SetClanTag("ok       ", "XenoHook.xyz"); break;
		case 17:SetClanTag("k        ", "XenoHook.xyz"); break;
		case 18:SetClanTag("         ", "XenoHook.xyz"); break;
		case 19:SetClanTag("          ", "XenoHook.xyz"); break;
		}
		counter++;
	}
	break;
	...
	case 2:
	{
		...
		int value = ServerTime % 17;
		switch (value) {
		case 0:SetClanTag("          ", "PinkyWare.club"); break;
		case 1:SetClanTag("         P", "PinkyWare.club"); break;
		case 2:SetClanTag("        Pi", "PinkyWare.club"); break;
		case 3:SetClanTag("       Pin", "PinkyWare.club"); break;
		case 4:SetClanTag("      Pink", "PinkyWare.club"); break;
		case 5:SetClanTag("     Pinky", "PinkyWare.club"); break;
		case 6:SetClanTag("    Pinky", "PinkyWare.club"); break;
		case 7:SetClanTag("   PinkyW", "PinkyWare.club"); break;
		case 8:SetClanTag(" PinkyWa", "PinkyWare.club"); break;
		case 9:SetClanTag("PinkyWar ", "PinkyWare.club"); break;
		case 10:SetClanTag("PinkyWare  ", "PinkyWare.club"); break;
		case 11:SetClanTag("PinkyWar   ", "PinkyWare.club"); break;
		case 12:SetClanTag("PinkyWa   ", "PinkyWare.club"); break;
		case 13:SetClanTag("PinkyW     ", "PinkyWare.club"); break;
		case 14:SetClanTag("Pinky      ", "PinkyWare.club"); break;
		case 15:SetClanTag("Pink       ", "PinkyWare.club"); break;
		case 16:SetClanTag("Pin       ", "PinkyWare.club"); break;
		case 17:SetClanTag("Pi       ", "PinkyWare.club"); break;
		case 18:SetClanTag("P       ", "PinkyWare.club"); break;
		case 19:SetClanTag("       ", "PinkyWare.club"); break;
		}
		counter++;
	}
	}
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{
		//Render::GradientV(51,255,255, Color(0, 0, 0, 0), Color(51, 255, 255));
		Render::Text(5, 5, Color(255, 102, 255, 220), Render::Fonts::Menu, "PinkyyWare");
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			Hacks::DrawHacks();
...
bool __stdcall Hooked_InPrediction()
{
	...
	if (Menu::Window.VisualsTab.OtherNoVisualRecoil.GetState() && (DWORD)(NULL()) == Offsets::Functions::dwCalcPlayerView)
	{

...
enum EFontFlags
{
	...
	FONTFLAG_ANTIALIAS = 0x012,
	FONTFLAG_FROSTY = 0x011,
...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "DINPro-Regular", 14, 900, 0, 0, FONTFLAG_FROSTY);
	 Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "Visitor TT2 BRK", 14, 500, 0, 0, FONTFLAG_FROSTY);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "SkipLegDay", 16, 500, 0, 0, FONTFLAG_FROSTY);

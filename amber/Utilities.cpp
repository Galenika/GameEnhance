...
ULONG Utilities::Memory::PatternSearch(std::string sModuleName, PBYTE pbPattern, std::string sMask, ULONG uCodeBase, ULONG uSizeOfCode)
{
	BOOL bPatternDidMatch = FALSE;
...
DWORD Utilities::Memory::FindPatternVersion2(std::string moduleName, std::string pattern)
{
...
void* Utilities::Memory::Hook(void* pInstance, int iIndex, void* pHookFunc)
{
...
int Utilities::FindNet(const char *table, const char *var)
{

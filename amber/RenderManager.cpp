...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tab, "Arial", 55, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::BITWare, "Arial", 38, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);

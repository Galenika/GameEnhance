...
void Hooked_RecvProxy_Viewmodel(CRecvProxyData *pData, void *pStruct, void *pOut)
{
	...
	int default_t = Interfaces::ModelInfo->GetModelIndex(XorStr("models/weapons/v_knife_default_t.mdl"));
	int default_ct = Interfaces::ModelInfo->GetModelIndex(XorStr("models/weapons/v_knife_default_ct.mdl"));
	...
	if (Menu::Window.MiscTab.KnifeModel.GetIndex() != 0 && pLocal)
	{
			...
			pData->m_Value.m_Int == iBowie))
		{
			...
			if (Menu::Window.MiscTab.KnifeModel.GetIndex() == 1)
				pData->m_Value.m_Int = iBayonet;
				...
				pData->m_Value.m_Int = iM9Bayonet;
			else if (Menu::Window.MiscTab.KnifeModel.GetIndex() == 10)
				pData->m_Value.m_Int = iDagger;
		}
	}

...
void AngletoVectors(Vector &angles, Vector *forward, Vector *right, Vector *up);
...
bool IsVisibleNEW(Vector& StartPos, Vector& EndPos, IClientEntity* localPly, IClientEntity* pEnt);

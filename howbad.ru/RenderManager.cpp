...
void Render::Initialise()
{
	...
	Fonts::ESPText = Interfaces::Surface->FontCreate();
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "verdana", 12, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "verdana", 12, 900, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "impact", 15, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESPText, "impact", 15, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::WaterMark, "impact", 18, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "verdana", 12, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Checkbox, "Segoe WP SemiLight", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);

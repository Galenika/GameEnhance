...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "HowBad.RU"); break;
		case 1:SetClanTag("         H", "HowBad.RU"); break;
		case 2:SetClanTag("        Ho", "HowBad.RU"); break;
		case 3:SetClanTag("       How", "HowBad.RU"); break;
		case 4:SetClanTag("      HowB", "HowBad.RU"); break;
		case 5:SetClanTag("     HowBa", "HowBad.RU"); break;
		case 6:SetClanTag("    HowBad", "HowBad.RU"); break;
		case 7:SetClanTag("   HowBad.", "HowBad.RU"); break;
		case 8:SetClanTag("  HowBad.R", "HowBad.RU"); break;
		case 9:SetClanTag(" HowBad.RU", "HowBad.RU"); break;
		case 10:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 11:SetClanTag("owBad.RU  ", "HowBad.RU"); break;
		case 12:SetClanTag("wBad.RU   ", "HowBad.RU"); break;
		case 13:SetClanTag("Bad.RU    ", "HowBad.RU"); break;
		case 14:SetClanTag("ad.RU     ", "HowBad.RU"); break;
		case 15:SetClanTag("d.RU      ", "HowBad.RU"); break;
		case 16:SetClanTag(".RU       ", "HowBad.RU"); break;
		case 17:SetClanTag("RU        ", "HowBad.RU"); break;
		case 18:SetClanTag("U         ", "HowBad.RU"); break;
		}
		counter++;
	}
	break;
	case 2:
	{
		...
		case 1:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 2:SetClanTag("       ", "HowBad.RU"); break;
		case 3:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 4:SetClanTag("       ", "HowBad.RU"); break;
		case 5:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 6:SetClanTag("       ", "HowBad.RU"); break;
		case 7:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 8:SetClanTag("       ", "HowBad.RU"); break;
		case 9:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 10:SetClanTag("       ", "HowBad.RU"); break;
		case 11:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 12:SetClanTag("       ", "HowBad.RU"); break;
		case 13:SetClanTag("HowBad.RU ", "HowBad.RU"); break;
		case 14:SetClanTag("       ", "HowBad.RU"); break;
	...
	case 3:
		// stainless
		SetClanTag("HowBad.RU", "HowBad.RU");
		break;
	case 4:
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
		Render::Text(10, 10, Color(255, 255, 255, 220), Render::Fonts::WaterMark, "HowBad.RU CS:GO"); /*Draw-Watermark*/
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
		Render::Textf(10, 25, Color(255, 255, 255, 220), Render::Fonts::WaterMark, ("%s"), __DATE__); /*Draw-Watermark*/
			Hacks::DrawHacks();
		Menu::DoUIFrame();
	}
}

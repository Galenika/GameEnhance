...
void CCheckBox::Draw(bool hover)
{
	...
	if (Checked)
		Render::Text(a.x + 1, a.y, Color(31, 232, 233, 255), Render::Fonts::MenuSymbols, L"\uE10B");
	Render::Clear(a.x, a.y, UI_CHK_SIZE, UI_CHK_SIZE, Color(40, 40, 40, 200));
...
void CSlider::Draw(bool hover)
{
	...
	if (Location == 0)
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2 + 3, a.y + 10, Color(200, 200, 200, 255), Render::Fonts::MenuText, buffer);
	else
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2, a.y + 10, Color(200, 200, 200, 255), Render::Fonts::MenuBold, buffer);
}

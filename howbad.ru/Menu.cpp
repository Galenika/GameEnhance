...
void AyyWareWindow::Setup()
{
	...
	ConfigBox.AddItem("Rage Matchmaking");
	ConfigBox.AddItem("Rage NoSpread");
	ConfigBox.AddItem("Legit Matchmaking");
	ConfigBox.SetPosition(20, Client.bottom - 155);
	ConfigBox.SetSize(95, 50);

	SaveButton.SetText("Save");
	SaveButton.SetCallback(SaveLegitCallbk);
	SaveButton.SetSize(95, 50);
	SaveButton.SetPosition(20, Client.bottom - 130);

	LoadButton.SetText("Load");
	LoadButton.SetCallback(LoadLegitCallbk);
	LoadButton.SetSize(95, 50);
	LoadButton.SetPosition(20, Client.bottom - 95);
...
#pragma region Aimbot
	...
	AimbotGroup.SetPosition(8, 25); /*1:Up/Down 2:Left/Right*/
	AimbotGroup.SetText("Aimbot");
	AimbotGroup.SetSize(320, 220);
	...
	AimbotGroup.PlaceLabledControl("Auto Shoot", this, &AimbotAutoFire);
	...
	AimbotSilentAim.AddItem("Disabled");
	AimbotSilentAim.AddItem("Client");
	AimbotSilentAim.AddItem("Client Choked");
	AimbotGroup.PlaceLabledControl("Silent Method", this, &AimbotSilentAim);

	AimbotAimStep.SetFileId("aim_aimstep");
	AimbotGroup.PlaceLabledControl("Casual Rage Mode", this, &AimbotAimStep);

	AimbotKeyPress.SetFileId("aim_usekey");
	AimbotGroup.PlaceLabledControl("Aimbot On Key", this, &AimbotKeyPress);
...
#pragma region Target
	TargetGroup.SetPosition(8, 255);
	TargetGroup.SetText("Targeting");
	TargetGroup.SetSize(320, 220);
	...
	TargetSelection.AddItem("HP Based");
	...
	TargetGroup.PlaceLabledControl("Single-Hitbox", this, &TargetHitbox);

	TargetHitscan.SetFileId("tgt_hitscan");
	TargetHitscan.AddItem("Disabled"); /*Disabled*/
	TargetHitscan.AddItem("Normal"); /*Normal*/
	TargetHitscan.AddItem("All-High"); /*All-High*/
	TargetHitscan.AddItem("All-Intense"); /*All-Intense*/
	TargetGroup.PlaceLabledControl("Multi-Box", this, &TargetHitscan);

	TargetSmartScan.SetFileId("acc_smart");
	TargetSmartScan.SetBoundaries(0, 20);
	TargetSmartScan.SetValue(1);
	TargetGroup.PlaceLabledControl("Body-Aim After X Shots", this, &TargetSmartScan);

	TargetMultipoint.SetFileId("tgt_multipoint");
	TargetGroup.PlaceLabledControl("Best-Point", this, &TargetMultipoint);

#pragma endregion Targetting controls 

#pragma region Accuracy
	AccuracyGroup.SetPosition(325, 255);
	AccuracyGroup.SetText("Accuracy");
	AccuracyGroup.SetSize(300, 220);
	...
	AccuracyGroup.PlaceLabledControl("Auto-Penetration", this, &AccuracyAutoWall);

	AccuracyAutoScope.SetFileId("acc_scope");
	AccuracyGroup.PlaceLabledControl("Sniper-Auto-Zoom", this, &AccuracyAutoScope);
	...
	AccuracyResolver.AddItem("Disabled");
	AccuracyResolver.AddItem("Auto Yaw");
	AccuracyResolver.AddItem("Auto Yaw + Pitch");
	AccuracyGroup.PlaceLabledControl("Anti-Aimbot-Correction", this, &AccuracyResolver);

	AccuracyHitchance.SetFileId("acc_chance");
	AccuracyHitchance.SetBoundaries(0.f, 100.f);
	AccuracyHitchance.SetValue(0.f);
	AccuracyGroup.PlaceLabledControl("Weapon-Inaccuracy Limit", this, &AccuracyHitchance);

	AccuracyMinimumDamage.SetFileId("acc_mindmg");
	AccuracyMinimumDamage.SetBoundaries(1.f, 99.f);
	AccuracyMinimumDamage.SetValue(1.f);
	AccuracyGroup.PlaceLabledControl("Auto-Penetration-Damage", this, &AccuracyMinimumDamage);

#pragma endregion  Accuracy controls get Setup in here

#pragma region AntiAim
	AntiAimGroup.SetPosition(325, 25); //344
	AntiAimGroup.SetText("HvH");
	AntiAimGroup.SetSize(300, 220);
	...
	AntiAimGroup.PlaceLabledControl("Offset Jitter", this, &AntiAimOffset);

	AntiAimKnife.SetFileId("aa_knife");
	AntiAimGroup.PlaceLabledControl("AA-Knife", this, &AntiAimKnife);

	AntiAimAtTargets.SetFileId("acc_aatargets");
	AntiAimGroup.PlaceLabledControl("AA-Targets", this, &AntiAimAtTargets);
...
void CLegitBotTab::Setup()
{
	...
	ActiveLabel.SetPosition(322, 16);
	ActiveLabel.SetText("Master Switch");
	RegisterControl(&ActiveLabel);

	Active.SetFileId("active");
	Active.SetPosition(408, 16);
	RegisterControl(&Active);

#pragma region Aimbot
	AimbotGroup.SetPosition(8, 25);
	AimbotGroup.SetText("Aimbot");
	AimbotGroup.SetSize(320, 220);
	RegisterControl(&AimbotGroup);
	...
	AimbotGroup.PlaceLabledControl("Target-Team", this, &AimbotFriendlyFire);
	...
	AimbotGroup.PlaceLabledControl("Rapid-Fire", this, &AimbotAutoPistol);

#pragma endregion Aimbot shit

#pragma region Main Weapon
	WeaponMainGroup.SetPosition(325, 25);
	WeaponMainGroup.SetText("Rifles-Other");
	WeaponMainGroup.SetSize(300, 220);
	...
	WeaponMainGroup.PlaceLabledControl("Aim-Speed", this, &WeaponMainSpeed);
	...
	WeaponMainGroup.PlaceLabledControl("P-Silent-Aim", this, &WeaponMainPSilent);
	...
	WeaponMainGroup.PlaceLabledControl("Aim-Bone", this, &WeaponMainHitbox);
#pragma endregion

#pragma region Pistols
	WeaponPistGroup.SetPosition(8, 255);
	WeaponPistGroup.SetText("Pistols");
	WeaponPistGroup.SetSize(320, 220);
	...
	WeaponPistGroup.PlaceLabledControl("Aim-Speed", this, &WeaponPistSpeed);
	...
	WeaponPistGroup.PlaceLabledControl("P-Silent-Aim", this, &WeaponPistPSilent);
	...
	WeaponPistGroup.PlaceLabledControl("Aim-Bone", this, &WeaponPistHitbox);
#pragma endregion

#pragma region Snipers
	WeaponSnipGroup.SetPosition(325, 255);
	WeaponSnipGroup.SetText("Snipers");
	WeaponSnipGroup.SetSize(300, 220);
	...
	WeaponSnipGroup.PlaceLabledControl("Aim-Speed", this, &WeaponSnipSpeed);
	...
	WeaponSnipGroup.PlaceLabledControl("P-Silent-Aim", this, &WeaponSnipPSilent);
	...
	WeaponSnipGroup.PlaceLabledControl("Aim-Bone", this, &WeaponSnipHitbox);
#pragma endregion
}
...
#pragma region Options
	OptionsGroup.SetText("Main");
	OptionsGroup.SetPosition(8, 25);
	OptionsGroup.SetSize(183, 260);
	RegisterControl(&OptionsGroup);

	 Active.SetFileId("opt_visenable");
	OptionsGroup.PlaceLabledControl("Enable", this, &Active);

	OptionsName.SetFileId("opt_name");
	OptionsGroup.PlaceLabledControl("Draw-Name", this, &OptionsName);

	OptionsBars.SetFileId("opt_box");
	OptionsBars.AddItem("Disabled");
	OptionsBars.AddItem("Health Bar");
	OptionsBars.AddItem("Armor Bar");
	OptionsBars.AddItem("Both");
	OptionsGroup.PlaceLabledControl("Draw-Vitals", this, &OptionsBars);

	OptionsBox.SetFileId("opt_box");
	OptionsBox.AddItem("Disabled");
	OptionsBox.AddItem("Full Box");
	...
	OptionsGroup.PlaceLabledControl("Show-Weapon", this, &OptionsWeapon);

	OptionsChams.SetFileId("opt_chams");
	OptionsChams.AddItem("Disabled");
	...
	OptionsGroup.PlaceLabledControl("Reveal-Ranks", this, &OptionsCompRank);

#pragma endregion Setting up the Options controls

#pragma region Filters
	FiltersGroup.SetText("Selection");
	FiltersGroup.SetPosition(190, 25);
	FiltersGroup.SetSize(180, 260);
	RegisterControl(&FiltersGroup);

	FiltersAll.SetFileId("ftr_all");
	FiltersGroup.PlaceLabledControl("Render-All", this, &FiltersAll);

	FiltersPlayers.SetFileId("ftr_players");
	FiltersGroup.PlaceLabledControl("Render-Players", this, &FiltersPlayers);

	FiltersWeapons.SetFileId("ftr_weaps");
	FiltersGroup.PlaceLabledControl("Render-Weapons", this, &FiltersWeapons);

	FiltersC4.SetFileId("ftr_c4");
	FiltersGroup.PlaceLabledControl("Render-C4", this, &FiltersC4);

	FiltersEnemiesOnly.SetFileId("ftr_enemyonly");
	FiltersGroup.PlaceLabledControl("Only-Targets", this, &FiltersEnemiesOnly);
#pragma endregion Setting up the Filters controls

#pragma region Other
	OtherGroup.SetText("Other");
	OtherGroup.SetPosition(370, 25);
	OtherGroup.SetSize(255, 260);
	...
	OtherGroup.PlaceLabledControl("Remove-Flashbang", this, &OtherNoFlash);

	OtherRadar.SetFileId("otr_radar");
	OtherGroup.PlaceLabledControl("Radar-Show-Target", this, &OtherRadar);

	OtherCrosshair.SetFileId("otr_xhair");
	OtherGroup.PlaceLabledControl("Draw-Crosshair", this, &OtherCrosshair);

	OtherRecoilCrosshair.SetFileId("otr_recoilhair");
	OtherRecoilCrosshair.AddItem("Disabled");
	OtherRecoilCrosshair.AddItem("Recoil-Position");
	OtherRecoilCrosshair.AddItem("Radius");
	OtherGroup.PlaceLabledControl("RCS-Crosshair", this, &OtherRecoilCrosshair);

	OtherNoHands.SetFileId("otr_hands");
	OtherNoHands.AddItem("Disabled");
	OtherNoHands.AddItem("Hand-Remove");
	OtherNoHands.AddItem("Hand-Ghost");
	OtherNoHands.AddItem("Hand-Chams");
	OtherNoHands.AddItem("Hand-Rainbow");
	OtherGroup.PlaceLabledControl("Hand-Material", this, &OtherNoHands);

	OtherFOV.SetFileId("otr_fov");
	OtherFOV.SetBoundaries(0.f, 125.f);
	OtherFOV.SetValue(90.f);
	OtherGroup.PlaceLabledControl("Client-FOV", this, &OtherFOV);

	OtherViewmodelFOV.SetFileId("otr_viewfov");
	OtherViewmodelFOV.SetBoundaries(0.f, 25.f);
...
#pragma region WorldOptions
	CvarGroup.SetText("World-Options");
	CvarGroup.SetPosition(8, 295);
	CvarGroup.SetSize(362, 155);
	...
	AmbientSkybox.AddItem("Skybox-Beautiful-Night");
...
#pragma region Other
	...
	OtherGroup.PlaceLabledControl("Draw-Spectators", this, &OtherSpectators);
	...
	OtherAutoStrafe.AddItem("Legit-Strafe");
	OtherAutoStrafe.AddItem("HvH-Strafe");
	OtherGroup.PlaceLabledControl("Strafe-Mode", this, &OtherAutoStrafe);

	OtherClantag.SetFileId("otr_spam");
	OtherClantag.AddItem("Disabled");
	OtherClantag.AddItem("HowBad.RU Slide");
	OtherClantag.AddItem("HowBad.RU Blink");
	OtherClantag.AddItem("HowBad.RU Static");
	OtherClantag.AddItem("Official Valve");
	OtherGroup.PlaceLabledControl("Set-Clantag", this, &OtherClantag);

	OtherChatSpam.SetFileId("otr_spam");
	OtherChatSpam.AddItem("Disabled");
	OtherChatSpam.AddItem("Namestealer");
	OtherChatSpam.AddItem("Regular");
	OtherChatSpam.AddItem("HowBad.RU");
	...
	OtherGroup.PlaceLabledControl("Team-Chat", this, &OtherTeamChat);
...
#pragma region FakeLag
	FakeLagGroup.SetPosition(225, 25);
	FakeLagGroup.SetSize(400, 140);
...
void CSkinchangerTab::Setup()
{
	...
	SkinApply.SetPosition(400, 5);
	SkinApply.SetSize(220, 106);
	RegisterControl(&SkinApply);

#pragma region Knife
	KnifeGroup.SetPosition(16, 40); /*1: Left/Right 2: Up/Down*/
	KnifeGroup.SetText("Knife");
	KnifeGroup.SetSize(276, 80);
...
#pragma region Snipers
	Snipergroup.SetPosition(16, 130);
...
#pragma region Rifles
	Riflegroup.SetPosition(16, 265);
	Riflegroup.SetText("Rifles");
	Riflegroup.SetSize(276, 195);
...
#pragma endregion
	...
	#pragma region MPs
		MPGroup.SetPosition(293, 265);
		MPGroup.SetText("MPs");
		MPGroup.SetSize(330, 195);
...
#pragma region Pistols
	PistolGroup.SetPosition(293, 40);

...
void SetupFonts()
{
	...
	Surface->SetFontGlyphSet(ESP = Surface->Create_Font(), XorStr("Terminus (TTF)"), 12, 600, NULL, NULL, FONTFLAG_OUTLINE);
	...
	Surface->SetFontGlyphSet(Watermark = Surface->Create_Font(), XorStr("Arial Bold"), 15, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE);

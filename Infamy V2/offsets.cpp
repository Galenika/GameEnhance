...
void GrabOffsets()
{
	...
	offsets.m_flLowerBodyYawTarget = NetVars->GetOffset(XorStr("DT_CSPlayer"), XorStr("m_flLowerBodyYawTarget"));
	...
	offsets.LineGoesThroughSmokeEx = Memory::FindPatternIDA("client.dll", "55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F 57 C0");
}